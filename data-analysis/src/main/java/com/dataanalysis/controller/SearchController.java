...
public class SearchController {
	...
	public void processSearch(String search) throws Exception {
...
//				+ "&date_from=20030520&date_to=" + myCurDate + "&date_option=4&start=" + pageNo;
		...
		BufferedWriter out = new BufferedWriter(new FileWriter("/Users/jeonghyeoncheol/Desktop/test/test.txt"));
		...
		int totalNum = getTotalSearched(array[1].trim());
